...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    'C:/Users/white/Desktop/riot-starter',
    '/home/ubuntu/riot-starter-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-starter-temp && mkdir riot-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-starter-temp/* riot-starter/ && rm -rf riot-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-starter && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-starter-temp` folder.');
